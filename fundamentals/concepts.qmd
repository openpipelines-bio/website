...
**Language independence.** Each component can be written in whatever language best suits the task. A normalization step might be in Python, a statistical test in R, and a file conversion in Bash. Viash wraps each script with a generated CLI and injects the parsed arguments, so components are interchangeable regardless of language.
