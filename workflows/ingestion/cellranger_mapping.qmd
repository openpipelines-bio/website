...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main_build/openpipelines/workflows/ingestion/cellranger_mapping){.btn-action .btn-sm .btn-info .btn role="button"}
...
flowchart LR
    ...
    p4(flatMap)
    p14(join)
    p12(cellranger_count)
    p23(join)
    p21(cellranger_count_split)
    p33(join)
    p31(from_10xh5_to_h5mu)
    p39(Output)
    p0-->p2
    p2-->p4
    p4-->p14
