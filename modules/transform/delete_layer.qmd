...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/experiment_website_push/src/transform/delete_layer){.btn-action .btn-sm .btn-info .btn role="button"}
