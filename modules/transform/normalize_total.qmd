...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main/openpipelines/src/transform/normalize_total){.btn-action .btn-sm .btn-info .btn role="button"}
