...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main_build/openpipelines/src/dataflow/concat){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--input_id`           |Names of the different samples that have to be concatenated.  Must be specified when using '--mode move'. In this case, the ids will be used for the columns names of the dataframes registring the conflicts. If specified, must be of same length as `--input`.                                                                                                                                                                                                                                                                  |`string`                                    |
