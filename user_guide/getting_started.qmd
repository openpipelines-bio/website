...
OpenPipelines workflows run on Nextflow and Docker. This page covers what you need to install depending on whether you plan to run workflows locally or in the cloud.
