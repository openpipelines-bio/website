...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/mapping/cellranger_multi/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
|:----------|:--------------------------------------------------|:--------------------|
|`--input`                        |The FASTQ files to be analyzed. FASTQ files should conform to the naming conventions of bcl2fastq and mkfastq: `[Sample Name]_S[Sample Index]_L00[Lane Number]_[Read Type]_001.fastq.gz`                                                                                                                                          |List of `file`, required, example: `"mysample_S1_L001_R1_001.fastq.gz", "mysample_S1_L001_R2_001.fastq.gz"`, multiple_sep: `";"` |
