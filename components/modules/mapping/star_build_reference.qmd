...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/mapping/star_build_reference/config.vsh.yml){.btn-action .btn-sm .btn-info .btn role="button"}
