...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/mapping/star_build_reference/config.vsh.yml){.btn-action .btn-sm .btn-info .btn role="button"}
