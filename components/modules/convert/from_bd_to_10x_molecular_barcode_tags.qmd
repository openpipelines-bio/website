...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/convert/from_bd_to_10x_molecular_barcode_tags/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
