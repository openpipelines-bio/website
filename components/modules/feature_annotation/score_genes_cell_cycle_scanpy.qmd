...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/2.1.2/src/feature_annotation/score_genes_cell_cycle_scanpy/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
