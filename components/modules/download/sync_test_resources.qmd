...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main/openpipelines/src/download/sync_test_resources){.btn-action .btn-sm .btn-info .btn role="button"}
