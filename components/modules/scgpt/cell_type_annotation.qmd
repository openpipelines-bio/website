...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/2.1.0/src/scgpt/cell_type_annotation/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
