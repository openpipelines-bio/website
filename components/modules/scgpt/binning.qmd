...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/scgpt/binning/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--binned_layer`       |The name of the adata layer to write the binned data to.   |`string`, default: `"binned"`              |
