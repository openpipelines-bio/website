...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/scgpt/embedding/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--dbsn`       |Whether to apply domain-specific batch normalization for generating embeddings. When set to True, 'obs_batch_labels' must be set as well. |`boolean`, default: `TRUE`   |
