...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/scgpt/pad_tokenize/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--input_layer`    |The name of the layer to be padded and tokenized.                                                                    |`string`, default: `"binned"`             |
