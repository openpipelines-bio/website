...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.2/src/correction/cellbender_remove_background_v0_2/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
