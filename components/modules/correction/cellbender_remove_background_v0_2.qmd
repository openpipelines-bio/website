...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/correction/cellbender_remove_background_v0_2/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
