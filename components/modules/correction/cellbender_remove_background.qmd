...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.10.0/./src/correction/cellbender_remove_background){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--z_layers`                          |Dimension of hidden layers in the encoder for z.                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |`integer`, default: `512`   |
...
|`--ignore_features`                   |Integer indices of features to ignore entirely. In the output count matrix, the counts for these features will be unchanged.                                                                                                                                                                                                                                                                                                                                                                                                   |`integer`                   |
...
|`--exclude_feature_types`             |Feature types to ignore during the analysis. These features will be left unchanged in the output file.                                                                                                                                                                                                                                                                                                                                                                                                                         |`string`                    |
