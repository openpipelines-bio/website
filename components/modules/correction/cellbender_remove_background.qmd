...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main_build/./src/correction/cellbender_remove_background){.btn-action .btn-sm .btn-info .btn role="button"}
