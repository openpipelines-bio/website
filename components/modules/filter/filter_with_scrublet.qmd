...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main/openpipelines/src/filter/filter_with_scrublet){.btn-action .btn-sm .btn-info .btn role="button"}
