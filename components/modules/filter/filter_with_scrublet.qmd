...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/filter/filter_with_scrublet/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
