...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/reference/cellranger_mkgtf/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
nextflow run openpipelines-bio/openpipeline \
  -r 1.0.1 -latest \
  -main-script target/nextflow/reference/mkgtf/main.nf \
  --help
```
