...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.1/src/reference/build_cellranger_arc_reference/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
genome: # please fill in - example: "GRCh38"
...
|`--genome`              |Name of the genome. This will be the name of the intermediate output folder                                                                                                                                                                                               |`string`, required, example: `"GRCh38"`                                     |
|`--organism`            |Name of the organism. This is displayed in the web summary but is otherwise not used in the analysis.                                                                                                                                                                     |`string`, default: `"Homo_sapiens"`                                         |
