...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.10.0/./src/qc/multiqc){.btn-action .btn-sm .btn-info .btn role="button"}
...
|:----------|:------------------------------------------------|:----------------------------------------|
|`--input`  |Inputs for MultiQC.                              |`file`, required, example: `"input.txt"` |
