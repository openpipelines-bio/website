...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/2.1.2/src/dataflow/split_h5mu_train_test/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
