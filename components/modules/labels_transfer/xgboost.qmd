...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/labels_transfer/xgboost/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
reference_obsm_features: # please fill in - example: "X_integrated_scanvi"
