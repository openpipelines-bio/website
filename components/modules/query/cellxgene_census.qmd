...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.12.7/src/query/cellxgene_census/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
# min_cells_filter_columns: 100.0
