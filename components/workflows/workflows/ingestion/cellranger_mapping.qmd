...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.0rc1/./src/workflows/ingestion/cellranger_mapping){.btn-action .btn-sm .btn-info .btn role="button"}
