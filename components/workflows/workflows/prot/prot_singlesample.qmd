...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v1.0.0-rc5/./src/workflows/prot/prot_singlesample){.btn-action .btn-sm .btn-info .btn role="button"}
