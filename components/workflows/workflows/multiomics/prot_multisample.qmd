...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/main_build/./src/workflows/multiomics/prot_multisample){.btn-action .btn-sm .btn-info .btn role="button"}
