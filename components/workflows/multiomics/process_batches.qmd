...
flowchart LR
    ...
    v565(publish)
    v593(Output)
    subgraph split_modalities_workflow
        v27(split_modalities_component)
    end
    subgraph rna_multisample
        v78(normalize_total)
        v98(log1p)
        v118(delete_layer)
    ...
    subgraph dimensionality_reduction_rna
        v417(pca)
        v437(find_neighbors)
        v457(umap)
    end
    subgraph dimensionality_reduction_prot
        v495(pca)
        v515(find_neighbors)
        v535(umap)
    end
