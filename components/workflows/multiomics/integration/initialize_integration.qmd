...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.10.0/workflows/multiomics/integration/initialize_integration){.btn-action .btn-sm .btn-info .btn role="button"}
