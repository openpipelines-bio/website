...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/0.11.2/./workflows/multiomics/prot_multisample){.btn-action .btn-sm .btn-info .btn role="button"}
