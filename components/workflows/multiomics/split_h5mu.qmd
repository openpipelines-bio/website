...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.2.0/src/workflows/multiomics/split_h5mu/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
