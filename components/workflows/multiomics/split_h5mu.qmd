...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.0.0/src/workflows/multiomics/split_h5mu/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
nextflow run openpipelines-bio/openpipeline \
  -r v4.0.0 -latest \
  -main-script target/_private/nextflow/workflows/multiomics/split_h5mu/main.nf \
  --help
```
