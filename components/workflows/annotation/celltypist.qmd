...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.0.0/src/workflows/annotation/celltypist/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
