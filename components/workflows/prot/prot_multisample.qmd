...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/4.0.0/src/workflows/prot/prot_multisample/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
