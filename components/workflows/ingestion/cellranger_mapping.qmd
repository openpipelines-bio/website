...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.1.1/src/workflows/ingestion/cellranger_mapping/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
