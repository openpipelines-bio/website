...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/1.0.5/src/workflows/ingestion/cellranger_multi/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
