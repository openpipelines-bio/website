...
# output_h5mu: ["$id.$key.output_h5mu_*.h5mu"]
...
|`--output_h5mu` |Locations for the output files. Must contain a wildcard (*) character, which will be replaced with the sample name. |List of `file`, required, example: `"*.h5mu"`, multiple_sep: `";"` |
